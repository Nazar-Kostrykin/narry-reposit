...
namespace kostrykin5
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            studList.Add(new Student("Shaposhnik Angelina Abdreevna", new DateTime(1998, 10, 10), new DateTime(2017, 9, 1), "b", 217, "E", "Power engineering", 68));
            ...
            studList.Add(new Student("Kostrykin Nazar Sergeevich", new DateTime(2002, 12, 10), new DateTime(2019, 9, 1), "b", 119, "CIT", "Computer engineering", 86));
